...
/*   Updated: 2023/01/12 16:42:04 by mmarinel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	const t_int_2d_point	start = (t_int_2d_point){
		endpoint[0].x + offset, endpoint[0].y
	};
	const t_int_2d_point	end = (t_int_2d_point){
		endpoint[1].x, endpoint[1].y
	};

	bresenham_plot(
		(t_int_2d_point[2]){start, end},
		&g->screen_handle.frame_data,
